...
- [ ] Extender `api/prospectos.php` para exponer datos necesarios de etapa B (si faltan)
- [ ] Extender `api/agenda.php`/`api/sync.php` si hace falta para persistencia compatible
- [ ] Implementar en `assets/app.js` módulo de etapa B (Información / Productos / Tiempo de Vida)
- [ ] Integrar guardado de evaluación en actividades
- [ ] Ajustar UI/estilos en `assets/app.css` para módulo nuevo
